...
function Sidebar({
  ...
  return (
    <aside className="w-96 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 p-6 overflow-y-auto h-[calc(100vh-89px)]">
      <motion.div
      ...
      >
        ...
        >
          ...
          <select
            ...
            className="w-full px-4 py-3 bg-white dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 rounded-xl text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all shadow-sm hover:shadow-md font-medium"
          >
              ...
              {selectedAlgorithm.parameters.map((param, index) => (
                ...
                >
                  <label className="flex justify-between items-center text-sm text-gray-600 dark:text-gray-400 mb-2 font-medium">
                    ...
                    <span className="px-2 py-1 bg-blue-600 text-white rounded-lg text-xs font-bold shadow-sm">
        ...
        <motion.div 
          ...
          className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-2 border-blue-200 dark:border-blue-800 shadow-sm"
        >
